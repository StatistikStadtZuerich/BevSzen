        ...
        #prediction   
            predi <- expand(data, !!sym(x) := t0:t1, !!!syms(group_cols)) %>% 
                ...
                #bandwidth: lower limit
                    ...
                    {if(invalid(lower_thres)){mutate(., lower_limit = pred_mean * (1 - thres_percent / 100))} else
                ...
                #bandwidth: upper limit
                    ...
                    {if(invalid(upper_thres)){mutate(., upper_limit = pred_mean * (1 + thres_percent / 100))} else
