...
# Birth plots for population scenarios
...
name <- ifelse(isTRUE(params$pdf_output), "0100_TFR_by-year", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0101_TFR_by-year-origin", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0102_TFR_by-year-age1", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0103_TFR_by-year-age2", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0104_TFR_by-year-age1-origin", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0105_TFR_by-year-age2", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0110_fertility_by-district-year-age-origin", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0111_fertility_by-year-age-origin", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0112_fertility_by-year-age", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0120_fertility_tail-correction", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0121_cumulative-population-from_tails", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0130_fertility_fit", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0140_fertility-prediction_by-district", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0141_fertility-prediction_by-district_along-year_Swiss", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0142_fertility-prediction_by-district_along-year_foreign", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0150_fertility-prediction_before-after-fit", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0160_TFR_by-district-origin", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0161_TFR_by-district-origin-age1", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0162_TFR_by-district-origin-age2", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0170_origin-change_by-year-origin", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0171_origin-change_by-year-age1-origin", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0172_origin-change_by-year-age2-origin", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0173_origin-change_by-district-year-origin", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0174_origin-change_by-district-year-age1-foreign", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0175_origin-change_by-district-year-origin_past-future", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0190_sex-ratio_by-year", "")
...
name <- ifelse(isTRUE(params$pdf_output), "0191_sex-ratio_by-year_with-mean", "")
