...
```{r}
#| label: fig-mis_past_pred_details
...
```{r}
#| label: fig-mis_smooth_plot_years
...
```{r}
#| label: fig-mis_age_prop_smooth_years
...
```{r}
#| label: fig-plot_a_past_pred_age_years
