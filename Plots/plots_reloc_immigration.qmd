---
title: "Relocation on immigration plots"
...
```{r}
#| label: fig-prop_dyao_smooth_age
...
```{r}
#| label: fig-prop_dyao_smooth_year
...
```{r}
#| label: fig-plot_agg_smooth_year
